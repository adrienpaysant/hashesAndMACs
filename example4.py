'''
Dart modify both message and MAC's digest knowing the secret key and the algorithm
'''
...
if __name__=='__main__':
    ...
    # Alice send the message to Bob (but Dart always here)
    send_message_digest(message, alice_digest, False, False)
